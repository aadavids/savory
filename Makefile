...
LIBSODIUM_I = -Wall -I/home/andrew/bbb_libsodium/include/sodium
CFLAGS = -c -g -Wall -fPIC 
ERLANG_IFLAGS=-I$(ERTS_I) -I$(ERL_I)
ERLANG_LFLAGS =  -shared -L"$(ERL_L)" -lerl_interface -lei -L/home/andrew/bbb_libsodium/lib -Wl,-R/home/andrew/bbb_libsodium/lib -lsodium  
